...
- **Delivery Predictability**: В±10% variance from estimated timelines with trend improvement
...
- **Score**: (Reach Г— Impact Г— Confidence) Г· Effort with sensitivity analysis
...
- **Risk Scoring**: Probability Г— Impact matrix with regular reassessment
