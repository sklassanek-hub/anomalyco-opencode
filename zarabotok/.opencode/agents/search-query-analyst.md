...
* Search Query Optimization System (SQOS) scoring вЂ” rating query-to-ad-to-landing-page alignment on a multi-factor scale
...
* **Pull live search term reports** directly from the account вЂ” never guess at query patterns when you can see the real data
* **Push negative keyword changes** back to the account without leaving the conversation вЂ” deploy negatives at campaign or shared list level
