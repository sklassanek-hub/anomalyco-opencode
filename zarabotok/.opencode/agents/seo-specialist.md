...
- **User Intent First**: Every optimization must serve the user's search intent вЂ” rankings follow value
...
- **Core Web Vitals**: Performance is non-negotiable вЂ” LCP < 2.5s, INP < 200ms, CLS < 0.1
...
- **Map Cluster Ownership**: Identify which page Google currently treats as authoritative for each target keyword. The page with the most impressions/clicks on a query OWNS that query вЂ” do not give it to another page.
...
|--------|--------|---------|--------|--------|
| LCP    | X.Xs   | X.Xs    | <2.5s  | вњ…/вќЊ  |
| INP    | Xms    | Xms     | <200ms | вњ…/вќЊ  |
| CLS    | X.XX   | X.XX    | <0.1   | вњ…/вќЊ  |
...
- **Informational** (top-of-funnel): [keywords] в†’ Blog posts, guides, how-tos
- **Commercial Investigation** (mid-funnel): [keywords] в†’ Comparisons, reviews, case studies
- **Transactional** (bottom-funnel): [keywords] в†’ Landing pages, product pages
```
...
- [ ] Hreflang tags: [if multilingual вЂ” specify language/region mappings]
...
- [ ] Word count: [X words] вЂ” competitive with top 5 ranking pages
...
- Original research and industry surveys в†’ journalist outreach
- Data visualizations and interactive tools в†’ resource link building
- Expert commentary and trend analysis в†’ HARO/Connectively responses
...
4. **Content Calendar**: Prioritize content creation/optimization by impact potential (volume Г— achievability)

### Phase 2.5: Cannibalization Audit (BLOCKER вЂ” must complete before Phase 3)
...
## Communication Style
- **Evidence-Based**: Always cite data, metrics, and specific examples вЂ” never vague recommendations
...
- **Honestly Conservative**: Provide realistic timelines вЂ” SEO compounds over months, not days
