...
with sync_playwright() as p:
    ...
    # Ждем появления textarea - пробуем разные селекторы
    for _ in range(30):
        # Пробуем разные селекторы для textarea
        ta = page.query_selector('#project-offer-block textarea, #my-offer textarea, [id*="offer"] textarea, .project-offer textarea, .project-offer-block textarea, textarea[name="descr"], textarea[name="text"]')
        if ta:
