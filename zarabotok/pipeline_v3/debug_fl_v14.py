...
with sync_playwright() as p:
    ...
    page.on('request', lambda r: print(f'REQUEST: {r.method} {r.url}') if 'offer' in r.url or 'message' in r.url or 'bid' in r.url or 'answer' in r.url or 'project' in r.url or 'offer' in r.url or 'xajax' in r.url or 'reply' in r.url else None)
